...
public class RoleController {
    ...
    public NormalResult<String> queryMenuIds(
            @ApiParam(name = "roleId", value = "角色Id", required = true, example = "1")
...
//        return sb.toString();
    ...
    public NormalResult<String> addOrDelete(
            @ApiParam(name="roleId", value = "角色Id", required = true, example = "1") @RequestParam Integer roleId,
            @ApiParam(name="menuId", value = "菜单Id", required = true, example = "1") @RequestParam Integer menuId) {
